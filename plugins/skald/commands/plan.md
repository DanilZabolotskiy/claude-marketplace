...
3. Новый функционал должен быть покрыт тестами — юнит, интеграционными или e2e, в зависимости от функционала. Это надо явно указывать в итерации, если она предполагает тесты.
